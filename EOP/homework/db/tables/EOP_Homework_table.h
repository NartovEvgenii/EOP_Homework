...
#define EOP_Type_Answer_Data_Table_create "CREATE TABLE IF NOT EXISTS " TYPE_ANSWER_DATA " (\n"\
                                          "    id INTEGER PRIMARY KEY AUTOINCREMENT,\n"\
                                          "    type_name TEXT,\n"\
                                          "    code_language TEXT\n"\
                                          ")"

#define EOP_Type_Answer_Stat_Table_create "CREATE TABLE IF NOT EXISTS " TYPE_ANSWER_STAT " (\n"\
                                          "    id INTEGER PRIMARY KEY AUTOINCREMENT,\n"\
                                          "    status_name TEXT\n"\
                                          ")"

#define EOP_Homework_Table_create "CREATE TABLE IF NOT EXISTS " HOMEWORK " (\n"\
                                    "    id INTEGER PRIMARY KEY AUTOINCREMENT,\n"\
                                    "    task_id INTEGER,\n"\
                                    "    student_ext_id TEXT,\n"\
                                    "    answer_text TEXT,\n"\
...
#define EOP_Type_Answer_Data_Table_init "INSERT OR IGNORE INTO " TYPE_ANSWER_DATA " (id, type_name, code_language)\n"\
                                          " VALUES (1, 'Java 1.8', 'JAVA'),\n"\
                                          " (2, 'C++ 11', 'CPP'),\n"\
                                          " (3, 'Python 3.12.0', 'PYTHON')\n"
                                          ;

#define EOP_Type_Answer_Stat_Table_init "INSERT OR IGNORE INTO " TYPE_ANSWER_STAT " (id, status_name)\n"\
                                        " VALUES (1, 'Загружено'),\n"\
                                        "(2, 'Ожидает проверки'),\n"\
                                        "(3, 'Оценено')\n"
